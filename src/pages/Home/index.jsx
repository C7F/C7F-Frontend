    ...
    return (
        <div>
            ...
            <article className="home-description">
                ...
                <Heading2 type="primary">Where?</Heading2>
                <p>
                    The CTF is online and anyone can take part in it!
                </p>
                <Heading2 type="primary">What?</Heading2>
                <p>
                ...
                <Heading2 type="primary">Flag format?</Heading2>
                <p>
                ...
                <Heading2 type="primary">Sponsors</Heading2>
                <p>
